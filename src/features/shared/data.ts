...
export const BRAND_NAME = "ALEXCODE";
export const FULL_NAME = "Alex Pratama";
...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      "Modern analytics dashboard dengan real-time charts dan responsive layout.",
    thumbnail:
  ...
  },
  {
    ...
    description:
      "Storefront cepat dengan checkout flow dan integrasi payment gateway.",
    thumbnail:
  ...
  },
  {
    ...
    description:
      "Aplikasi manajemen tugas dengan drag-and-drop dan offline support.",
    thumbnail:
  ...
  },
  {
    ...
    description:
      "Tool no-code untuk membuat portfolio responsive dalam hitungan menit.",
    thumbnail:
